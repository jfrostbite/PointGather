...
public class Constants {
    ...
    //数据库变化观察者规则
    public static final Uri POINT_URI = Uri.parse("content://com.kevin.identify");
    public static final Uri POINT_URI_NEW = Uri.parse("content://com.kevin.identify/new");
    public static final Uri POINT_URI_ADD = Uri.parse("content://com.kevin.identify/add");
